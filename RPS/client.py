...
def redrawWindow(win, game, p):
    ...
    if not(game.connected()):
        image_hourglass = pygame.image.load(r"C:\Users\Musta\PycharmProjects\RPS\hourglass-orange.png")
        ...
        image_rock = pygame.image.load(r"C:\Users\Musta\PycharmProjects\RPS\rock.png")
        image_paper = pygame.image.load(r"C:\Users\Musta\PycharmProjects\RPS\paper.png")
        image_scissor = pygame.image.load(r"C:\Users\Musta\PycharmProjects\RPS\scissors (1).png")
...
def menu_screen():
    run = True
    clock = pygame.time.Clock()
    image_rps=pygame.image.load(r"C:\Users\Musta\PycharmProjects\RPS\rock-paper-scissors-ten.png")
